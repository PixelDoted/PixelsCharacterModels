...
public class OffsetFlatButtonWidget extends ButtonWidget {
    ...
    public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        ClickableWidget.drawTextWithShadow(matrices, minecraftClient.textRenderer, this.getMessage(), this.x + 4, this.y + (this.height - 8) / 2, j | MathHelper.ceil(this.alpha * 255.0f) << 24);

...
public class PCMRenderEventHandler 
{
	...
	public void ClientTickEvent(TickEvent.ClientTickEvent event) {
		...
		if (Main.Data.playerData.size() > 0 && player == null) {
			Main.Data.playerData.clear();
		}
		if (player != null) {
			if (Main.Data.playerData.containsKey(player.getUniqueID())) {
	...
	public void setPartModels(CustomPlayerModel model, PlayerEntity player) {
		...
		data.parts.getLimbfromName("head").Renderer = network.FakeHead;
		data.parts.getLimbfromName("body").Renderer = network.FakeBody;
		data.parts.getLimbfromName("leftleg").Renderer = network.FakeLeftLeg;
		data.parts.getLimbfromName("leftarm").Renderer = network.FakeLeftArm;
		data.parts.getLimbfromName("rightleg").Renderer = network.FakeRightLeg;
		data.parts.getLimbfromName("rightarm").Renderer = network.FakeRightArm;
		
		data.parts.getLimbfromName("head").ModelRenderer = model.bipedHead;
		data.parts.getLimbfromName("body").ModelRenderer = model.bipedBody;
		data.parts.getLimbfromName("leftleg").ModelRenderer = model.bipedLeftLeg;
		data.parts.getLimbfromName("leftarm").ModelRenderer = model.bipedLeftArm;
		data.parts.getLimbfromName("rightleg").ModelRenderer = model.bipedRightLeg;
		data.parts.getLimbfromName("rightarm").ModelRenderer = model.bipedRightArm;
	}

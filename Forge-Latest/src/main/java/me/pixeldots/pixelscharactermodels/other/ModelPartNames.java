...
public class ModelPartNames {
    ...
    public ModelPartNames() {
        ...
        map.put(EntityType.PLAYER.getDescriptionId(), data);
    }

    // get Head Part Name
    public static String getHeadName(Entity entity, int part) {
        return getHeadName(entity.getType().getDescriptionId(), part);
    }
    // get Head Part Name
    ...
    public static String getBodyName(Entity entity, int part) {
        return getBodyName(entity.getType().getDescriptionId(), part);
    }
    // get Body Part Name

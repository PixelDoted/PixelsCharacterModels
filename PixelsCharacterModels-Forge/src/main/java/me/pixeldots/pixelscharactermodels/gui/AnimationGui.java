...
public class AnimationGui extends EntityGuiHandler {
    ...
    public void init() {
        ...
        // Left Panel
        if (selectedNode == -1) {
            File[] files = new File(this.minecraft.gameDirectory.getAbsolutePath() + File.separator + "PCM" + File.separator + "Animations" + path_offset).listFiles();
            ...
            addButton(new FlatButtonWidget(125, 45, 55, 10, Text("pcm.gui.Create"), (btn) -> {
                File file = new File(this.minecraft.gameDirectory.getAbsolutePath() + File.separator + "PCM" + File.separator + "Animations" + path_offset + File.separator + createname.getMessage().getString() + ".json");
                boolean result = AnimationHelper.write(file, animation);
                if (result == false)
            ...
            addButton(new FlatButtonWidget(125, 35, 55, 10, Text("pcm.gui.Rename"), (btn) -> {
                ...
                String new_name = createname.getMessage().getString();
